...
function Facilities() {
  ...
  const handleAddFacility = (e) => {
    ...
    const newFacility = {
      ...
      operatingHours: e.target.operatingHours.value || null,
      contactInfo: e.target.contactInfo.value || null,
      ...
      createdDate: new Date().toISOString(), // add timestamp for notifications
    };
              ...
              <tbody>
                {facilities.map((facility) => (
                  <tr key={facility.facilityId}>
                    ...
                    <td>{new Date(facility.createdDate).toLocaleString()}</td>
                  </tr>
                ))}
              </tbody>
            </table>
